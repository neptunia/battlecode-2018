...
public class Factory {
	...
	public static void run(GameController gc, Unit curUnit) {
		...
		if (!(Worker.rocketsBuilt == 0 && Worker.rocketBlueprintId == -1 && gc.researchInfo().getLevel(UnitType.Rocket) > 0) && gc.canProduceRobot(curUnit.id(), UnitType.Ranger) && !Player.splitMap) {
