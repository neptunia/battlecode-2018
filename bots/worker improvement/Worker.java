...
public class Worker {
	...
	public static void run(Unit curUnit) {
        ...
        if (Player.prevBlocked < 10 && Player.timesReachedTarget < 1 && gc.karbonite() + Player.karboniteGonnaUse >= 200 && gc.round() != 1 && Player.numFactory + structuresToBuild.size() < (split.get(myId) ? 3 : 6)) {
