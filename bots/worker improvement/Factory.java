...
public class Factory {
	...
	public static void run(Unit curUnit) {
		...
		if ((Player.prevBlocked < (Worker.split.get(myId) ? 4 : 8) && Player.timesReachedTarget < 1 && gc.round() < 600 && (gc.karbonite() + Player.karboniteGonnaUse > 140 || gc.researchInfo().getLevel(UnitType.Rocket) == 0)) || (Player.numRanger < 10 || Player.numHealer < 4)) {
