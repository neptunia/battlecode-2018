...
public class Factory {
	...
	public static void run(Unit curUnit) {
		...
		if (Player.prevBlocked < 15 && (Player.timesReachedTarget < 1 || (Player.numRanger < 10 && Player.numHealer < 4)) && gc.round() < 650 && (gc.karbonite() > 120 || gc.researchInfo().getLevel(UnitType.Rocket) == 0)) {
